...
public class MailUtil {
    ...
    private static String myEmailAccount = "1010551596@qq.com";
    private static String myEmailPassword = "gydbzcqqhzaxbege";
    ...
    private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String code) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "CodeCooperation-Team", "UTF-8"));
     ...
     * @throws Exception
     */
    public static void sendMail(String emlAddr, String code) throws Exception {
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, emlAddr, code);
